...
g_finish = False
g_key = [0]
# Use g_key to stored the move key the user input. 
# To realize the function that the last input will be implemented.
...
def monster_move():
    MONSTER_SPEED = 600 + random.randrange(-100,100)
    if g_on == 1 or g_on == 0:
...
def eat():
    ...
    # Other wise we will get float and it is difficult to check
